Crossbeams::MenuMigrations::Migrator.migration('Nspack') do
  up do
    ...
    add_program_function 'Fruit Defect Categories', functional_area: 'Masterfiles', program: 'Quality', group: 'QC', url: '/list/fruit_defect_categories', seq: 4
  end

  down do
    drop_program 'QC', functional_area: 'Quality'
    drop_program_function 'Fruit Defect Categories', functional_area: 'Masterfiles', program: 'Quality', match_group: 'QC'
  end
end
