Crossbeams::MenuMigrations::Migrator.migration('Nspack') do
  up do
    ...
    add_program_function 'Fruit Defect Types', functional_area: 'Masterfiles', program: 'Quality', group: 'QC', url: '/list/fruit_defect_types', seq: 4
    add_program_function 'Fruit Defects', functional_area: 'Masterfiles', program: 'Quality', group: 'QC', url: '/list/fruit_defects', seq: 5
  end
