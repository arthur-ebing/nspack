Crossbeams::MenuMigrations::Migrator.migration('Nspack') do
  up do
    add_program_function 'Swap Employees', functional_area: 'Masterfiles', program: 'HR', url: '/masterfiles/human_resources/shift_types/swap_employees', seq: 9, group: 'Shift Types'
  ...
  down do
    drop_program_function 'Swap Employees', functional_area: 'Masterfiles', program: 'HR'
