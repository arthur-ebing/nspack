Crossbeams::MenuMigrations::Migrator.migration('Nspack') do
  up do
    ...
    add_program_function 'Groups', functional_area: 'Masterfiles', program: 'Fruit', url: '/list/treatment_types', seq: 11, group: 'Treatments'
    add_program_function 'Treatments', functional_area: 'Masterfiles', program: 'Fruit', url: '/list/treatments', seq: 11, group: 'Treatments'
