Sequel.migration do
  up do
    ...
    run <<~SQL
      ...
      CREATE VIEW public.vw_carton_label_pset AS
        ...
        LEFT JOIN pucs mkt_org_pucs ON mkt_org_pucs.id = farm_puc_orgs.puc_id
        LEFT JOIN registered_orchards ON registered_orchards.puc_code = mkt_org_pucs.puc_code AND registered_orchards.cultivar_code = cultivars.cultivar_code AND marketing_orchard;
