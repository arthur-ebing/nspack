        ...
        CREATE OR REPLACE VIEW public.vw_scrapped_pallet_sequence_flat AS
         SELECT ps.id,
           ...
           FROM pallets p
             ...
             LEFT JOIN govt_inspection_sheets ON govt_inspection_sheets.id = govt_inspection_pallets.govt_inspection_sheet_id
             LEFT JOIN depots ON depots.id = loads.depot_id
             LEFT JOIN ( SELECT ps.pallet_id AS repacked_to_pallet_id, ps.pallet_number AS repacked_to_pallet_number, ps.repacked_from_pallet_id 
                         FROM pallet_sequences ps
                         JOIN pallets repacked_to_pallets ON repacked_to_pallets.id = ps.repacked_from_pallet_id) repacked_to_pallets ON repacked_to_pallets.repacked_from_pallet_id = p.id
