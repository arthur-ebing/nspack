  ...
  up do
    run <<~SQL
      ...
      AS SELECT qc_samples.id AS sample_id,
        ...
        pucs.puc_code,
        -- Orchard / Delivery
        COALESCE(delivery_orchard.orchard_code, orchards.orchard_code) AS orchard_code,
        -- Coldroom
        locations.location_long_code,
