      ...
      CREATE OR REPLACE VIEW public.vw_packout_details AS
       SELECT farms.farm_code,
          ...
          pallet_sequences.carton_quantity,
              ...
              END AS percentage,
          standard_product_weights.nett_weight * pallet_sequences.carton_quantity AS  derived_nett_weight
         FROM pallet_sequences
           ...
           LEFT  JOIN public.standard_pack_codes ON standard_pack_codes.id = pallet_sequences.standard_pack_code_id
