  ...
  up do
    ...
    run <<~SQL
      ...
      AS SELECT carton_labels.id AS carton_label_id,
          ...
          reg_mkt_gln.registration_code AS marketing_org_gln,
          ...
          CASE WHEN production_runs.lot_no_date IS NULL THEN
            NULL
          ELSE
            'L ' || LPAD(EXTRACT('week' FROM production_runs.lot_no_date)::text, 2, '0') || '-' || LPAD(EXTRACT('isodow' FROM production_runs.lot_no_date)::text, 2, '0')
          END AS ogl_number
         ...
         FROM carton_labels
           ...
           LEFT JOIN registrations reg_mkt_gln ON reg_mkt_gln.party_role_id = carton_labels.marketing_org_party_role_id AND reg_mkt_gln.registration_type = 'MARKETER_GLN'
    ...
    run <<~SQL
      ...
      AS SELECT pallet_sequences.id,
         ...
         FROM pallet_sequences
           ...
           LEFT JOIN organizations marketing_org ON marketing_org.id = mkt_pr.organization_id
           LEFT JOIN registrations reg_mkt_gln ON reg_mkt_gln.party_role_id = pallet_sequences.marketing_org_party_role_id AND reg_mkt_gln.registration_type = 'MARKETER_GLN'
    ...
    run <<~SQL
      ...
      AS SELECT product_setups.id AS carton_label_id,
         ...
         FROM product_resource_allocations
           ...
           LEFT JOIN organizations marketing_org ON marketing_org.id = mkt_pr.organization_id
           LEFT JOIN registrations reg_mkt_gln ON reg_mkt_gln.party_role_id = product_setups.marketing_org_party_role_id AND reg_mkt_gln.registration_type = 'MARKETER_GLN'
