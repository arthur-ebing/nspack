Sequel.migration do
  up do
    run <<~SQL
      ...
      CREATE TRIGGER rmt_bins_asset_queue_on_create_and_delete
      BEFORE INSERT OR DELETE
      ON public.rmt_bins
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_create_and_delete_rmt_bin_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER rmt_bins_asset_queue_on_bin_tipped_change
      AFTER UPDATE OF bin_tipped
      ON public.rmt_bins
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_bin_tipped_change_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER rmt_bins_asset_queue_on_scrapped_change
      AFTER UPDATE OF scrapped
      ON public.rmt_bins
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_bin_scrapped_change_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER rmt_bins_asset_queue_on_shipped_asset_number_change
      AFTER UPDATE OF shipped_asset_number
      ON public.rmt_bins
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_shipped_asset_number_change_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER rmt_bins_asset_queue_on_update
      AFTER UPDATE OF farm_id, rmt_material_owner_party_role_id, rmt_container_material_type_id
      ON public.rmt_bins
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_bin_update_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER pallet_bin_asset_queue_on_shipped_change
      AFTER UPDATE OF shipped
      ON public.pallets
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_pallet_bin_shipped_change_to_queue();
    SQL
    ...
    run <<~SQL
      ...
      CREATE TRIGGER pallet_bin_asset_queue_on_owner_update
      AFTER UPDATE OF rmt_container_material_owner_id
      ON public.pallets
      FOR EACH ROW
      EXECUTE PROCEDURE fn_add_pallet_bin_owner_update_to_queue();
    SQL
  end

  down do
    run <<~SQL
      DROP TRIGGER rmt_bins_asset_queue_on_create_and_delete ON public.rmt_bins;
      DROP FUNCTION public.fn_add_create_and_delete_rmt_bin_to_queue();

      DROP TRIGGER rmt_bins_asset_queue_on_bin_tipped_change ON public.rmt_bins;
      DROP FUNCTION public.fn_add_bin_tipped_change_to_queue();

      DROP TRIGGER rmt_bins_asset_queue_on_scrapped_change ON public.rmt_bins;
      DROP FUNCTION public.fn_add_bin_scrapped_change_to_queue();

      DROP TRIGGER rmt_bins_asset_queue_on_shipped_asset_number_change ON public.rmt_bins;
      DROP FUNCTION public.fn_add_shipped_asset_number_change_to_queue();

      DROP TRIGGER rmt_bins_asset_queue_on_update ON public.rmt_bins;
      DROP FUNCTION public.fn_add_bin_update_to_queue();

      DROP TRIGGER pallet_bin_asset_queue_on_shipped_change ON public.pallets;
      DROP FUNCTION public.fn_add_pallet_bin_shipped_change_to_queue();

      DROP TRIGGER pallet_bin_asset_queue_on_owner_update ON public.pallets;
      DROP FUNCTION public.fn_add_pallet_bin_owner_update_to_queue();
    SQL
  end
end
