Sequel.migration do
  up do
    ...
    create_table(:gtins, ignore_index_errors: true) do
      primary_key :id
      String :transaction_number, null: false
      String :gtin_code, null: false
      DateTime :date_to
      DateTime :date_from
      String :org_code
      String :commodity_code
      String :marketing_variety_code
      String :standard_pack_code
      String :grade_code
      String :mark_code
      String :size_count_code
      String :inventory_code
      String :target_market_code
      TrueClass :active, default: true
      DateTime :created_at, null: false
      DateTime :updated_at, null: false

      index [:transaction_number, :gtin_code], name: :gtin_unique_code, unique: true
    end

    pgt_created_at(:gtins,
                   :created_at,
                   function_name: :gtins_set_created_at,
                   trigger_name: :set_created_at)

    pgt_updated_at(:gtins,
                   :updated_at,
                   function_name: :gtins_set_updated_at,
    ...
    run <<~SQL
      ...
      CREATE OR REPLACE VIEW public.vw_pallet_sequence_flat AS
       SELECT ps.id,
          ...
          (ps.carton_quantity / standard_product_weights.ratio_to_standard_carton)::numeric AS std_ctns,
  ...
  down do
    ...
    drop_trigger(:gtins, :set_created_at)
    drop_function(:gtins_set_created_at)
    drop_trigger(:gtins, :set_updated_at)
    drop_function(:gtins_set_updated_at)
    drop_table(:gtins)
  end
end
