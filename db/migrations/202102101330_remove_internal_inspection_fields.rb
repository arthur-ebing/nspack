Sequel.migration do
  up do
    ...
    alter_table(:pallets) do
      drop_column :internal_inspection_at
      drop_column :internal_reinspection_at
  ...
  down do
    alter_table(:pallets) do
      add_column :internal_inspection_at, DateTime
      add_column :internal_reinspection_at, DateTime
