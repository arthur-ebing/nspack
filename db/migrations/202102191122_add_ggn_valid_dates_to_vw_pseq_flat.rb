    ...
    run <<~SQL
      ...
      CREATE OR REPLACE VIEW public.vw_pallet_sequence_flat
       ...
       SELECT ps.id,
          ...
          pucs.gap_code,
              CASE
                  WHEN ps.target_market_id IS NOT NULL AND target_markets.inspection_tm THEN target_markets.target_market_name
                  ELSE target_market_groups.target_market_group_name
              END AS inspection_tm ,pucs.gap_code_valid_from,pucs.gap_code_valid_until
         FROM pallets p
