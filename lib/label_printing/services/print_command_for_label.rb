...
module LabelPrintingApp
  ...
  class PrintCommandForLabel < BaseService
    ...
    def call
      ...
      field_positions = special_field_positions(lbl_required, %w[carton_label_id pick_ref pallet_number FNC:iso_day FNC:iso_week FNC:iso_weekday FNC:current_date])
