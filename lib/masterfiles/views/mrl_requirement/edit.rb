    ...
    module MrlRequirement
      class Edit
        def self.call(id, form_values: nil, form_errors: nil)
          ui_rule = UiRules::Compiler.new(:mrl_requirement, :edit, id: id, form_values: form_values)
          ...
          Crossbeams::Layout::Page.build(rules) do |page|
            ...
            page.form do |form|
              form.caption 'Edit Mrl Requirement'
              form.action "/masterfiles/quality/mrl_requirements/#{id}"
              form.remote!
              form.method :update
