...
module UiRules
  class DepotRule < Base
    ...
    def set_show_fields
      # city_id_label = MasterfilesApp::DestinationCityRepo.new.find_destination_city(@form_object.city_id)&.city_name
      city_id_label = @repo.find(:destination_cities, MasterfilesApp::DestinationRepo, @form_object.city_id)&.city_name
