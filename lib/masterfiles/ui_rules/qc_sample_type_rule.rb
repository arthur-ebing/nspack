...
module UiRules
  class QcSampleTypeRule < Base
    ...
    #   fields[:to] = { renderer: :select, options: user_repo.email_addresses(user_email_group: AppConst::EMAIL_GROUP_QC_SAMPLE_TYPE_APPROVERS), caption: 'Email address of person to notify', required: true }
    # end
    ...
    def make_new_form_object
      ...
      # @form_object = new_form_object_from_struct(MasterfilesApp::QcSampleType, merge_hash: { some_column: 'some value' })
      # @form_object = OpenStruct.new(qc_sample_type_name: nil,
      #                               description: nil)
    end
    ...
    #   end
    #   json_replace_select_options('qc_sample_type_an_id', sel)
    # end
  end
end
