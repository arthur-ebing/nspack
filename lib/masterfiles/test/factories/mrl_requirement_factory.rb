...
module MasterfilesApp
  module MrlRequirementFactory
    def create_mrl_requirement(opts = {}) # rubocop:disable Metrics/CyclomaticComplexity
      ...
      opts[:packed_tm_group_id] ||= create_target_market_group unless opts.key?(:packed_tm_group_id)
      ...
      opts[:target_customer_id] ||= create_party_role unless opts.key?(:target_customer_id)
