...
module Production
  module ProductSetups
    module ProductSetup
      class New
        def self.call(product_setup_template_id, back_url:, form_values: nil, form_errors: nil, remote: true)
              ...
              form.row do |row|
                row.column do |col|
                  col.fold_up do |fold|
                    ...
                    fold.add_field :colour_percentage_id
                  end
                end
                row.column do |col|
                  col.fold_up do |fold|
              ...
              form.row do |row|
                row.column do |col|
                  col.fold_up do |fold|
                    ...
                    fold.add_field :carton_label_template_id
                  end
                end
                row.column do |col|
                  col.fold_up do |fold|
