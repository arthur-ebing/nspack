    ...
    module GrowerGradingRuleItem
      class Clone
        def self.call(id, form_values: nil, form_errors: nil)
          ui_rule = UiRules::Compiler.new(:grower_grading_rule_item, :clone, id: id, form_values: form_values)
          ...
          Crossbeams::Layout::Page.build(rules) do |page|
            ...
            page.form do |form|
              form.caption 'Clone Grower Grading Rule Item'
              form.action "/production/grower_grading/grower_grading_rule_items/#{id}/clone_grower_grading_rule_item"
              form.remote!
              form.row do |row|
                row.column do |col|
                  col.add_field :id
