...
module ProductionApp
  class CreateReworksRun < BaseService # rubocop:disable Metrics/ClassLength
    ...
    def rmt_bin_change?
      AppConst::RUN_TYPE_TIP_BINS == reworks_run_type[:run_type] || AppConst::RUN_TYPE_WEIGH_RMT_BINS == reworks_run_type[:run_type] || AppConst::RUN_TYPE_BULK_WEIGH_BINS == reworks_run_type[:run_type]
    end
