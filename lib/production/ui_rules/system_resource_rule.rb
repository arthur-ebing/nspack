  ...
  class SystemResourceRule < Base
    ...
    def common_fields
                        ...
                        end
      {
        ...
        module_function: { invisible: @plant_resource_type == :scale, hint: '<p>The function as listed in central MesServer config (Function).</p>' },
        ...
        port: { renderer: :integer, invisible: @plant_resource_type == :scale,
                hint: '<p>TCP port (not required for non-TCP connection)<p></p>Typical values: <ul><li><strong>2080</strong> for MesServer</li><li><strong>2080</strong> for modules</li><li><strong>9100</strong> for TCP printers</li><li>Specific for other types</li></ul></p>' },
        ...
        module_action: { renderer: :select, options: Crossbeams::Config::ResourceDefinitions::MODULE_ACTIONS.keys,
                         hint: '<p>This is the action taken in NSPack - it defines the URL to be called.</p>' },
