    ...
    def common_fields # rubocop:disable Metrics/AbcSize
      {
        ...
        packhouse_resource_id: { renderer: :select,
                                 options: @repo.for_select_plant_resources(Crossbeams::Config::ResourceDefinitions::PACKHOUSE),
        ...
        production_line_id: { renderer: :select,
                              options: @repo.for_select_plant_resources(Crossbeams::Config::ResourceDefinitions::LINE),
                              disabled_options: ProductionApp::ResourceRepo.new.for_select_inactive_plant_resources,
        ...
        season_group_id: { renderer: :select,
                           options: MasterfilesApp::CalendarRepo.new.for_select_season_groups,
