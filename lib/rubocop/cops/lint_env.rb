  ...
  module Cop
    module Lint
      ...
      class Env < RuboCop::Cop::Cop
        MSG_ENV = 'Avoid direct usage of ENV in application code'.freeze
        MSG_RAILS_ENV = 'Avoid direct usage of Rails.env in application code'.freeze
        USAGE_MSG = ', use configuration parameters instead'.freeze
