...
module Quality
  module Qc
    module QcSample
      class New
        def self.call(context:, id:, form_values: nil, form_errors: nil, remote: true)
          ui_rule = UiRules::Compiler.new(:qc_sample, :new, context: context, context_key: id, form_values: form_values)
