    ...
    module OrderItem
      class Edit
        def self.call(id, form_values: nil, form_errors: nil) # rubocop:disable Metrics/AbcSize
          ui_rule = UiRules::Compiler.new(:order_item, :edit, id: id, form_values: form_values)
          ...
          layout = Crossbeams::Layout::Page.build(rules) do |page|
            ...
            page.form do |form|
              form.caption 'Edit Order Item'
              form.action "/finished_goods/orders/order_items/#{id}"
              form.remote!
              form.method :update
              form.row do |row|
                row.column do |col|
