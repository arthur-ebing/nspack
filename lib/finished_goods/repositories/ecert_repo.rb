...
module FinishedGoodsApp
  class EcertRepo < BaseRepo
    build_for_select :ecert_agreements, label: %i[code name], value: :id, order_by: :code
    build_inactive_select :ecert_agreements, label: %i[code name], value: :id, order_by: :code
