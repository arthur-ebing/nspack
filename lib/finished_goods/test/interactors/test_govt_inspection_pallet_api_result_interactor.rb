...
module FinishedGoodsApp
  class TestGovtInspectionPalletApiResultInteractor < MiniTestWithHooks
    ...
    def test_repo
      ...
      assert repo.is_a?(FinishedGoodsApp::GovtInspectionPalletApiResultRepo)
    end

    def test_govt_inspection_pallet_api_result
      skip 'pallet_factory needed'
      FinishedGoodsApp::GovtInspectionPalletApiResultRepo.any_instance.stubs(:find_govt_inspection_pallet_api_result).returns(fake_govt_inspection_pallet_api_result)
