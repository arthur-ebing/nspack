...
module FinishedGoodsApp
  class TestGovtInspectionPalletPermission < Minitest::Test
    ...
    def test_edit
      ...
      # FinishedGoodsApp::GovtInspectionRepo.any_instance.stubs(:find_govt_inspection_pallet).returns(entity(completed: true))
      # res = FinishedGoodsApp::TaskPermissionCheck::GovtInspectionPallet.call(:edit, 1)
    ...
    # def test_approve
    #   FinishedGoodsApp::GovtInspectionRepo.any_instance.stubs(:find_govt_inspection_pallet).returns(entity(completed: true, approved: false))
    ...
    #   FinishedGoodsApp::GovtInspectionRepo.any_instance.stubs(:find_govt_inspection_pallet).returns(entity(completed: true, approved: true))
    #   res = FinishedGoodsApp::TaskPermissionCheck::GovtInspectionPallet.call(:approve, 1)
