  ...
  module TaskPermissionCheck
    class PalletSequence < BaseService
      ...
      def initialize(tasks, args)
        ...
        @check_pallet_sequence_ids = Array(@args[:pallet_sequence_id] || @args[:pallet_sequence_ids])
      end
      ...
      def exists_check
        ...
        return failed_response 'No pallet sequences were given to check.' if pallet_sequence_ids.nil_or_empty?
