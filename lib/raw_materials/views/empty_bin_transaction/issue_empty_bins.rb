...
module RawMaterials
  module EmptyBins
    module EmptyBinTransaction
      class IssueEmptyBins
        def self.call(form_values: nil, form_errors: nil, remote: nil) # rubocop:disable Metrics/AbcSize
          ui_rule = UiRules::Compiler.new(:empty_bin_transaction, :issue, form_values: form_values)
          ...
          layout = Crossbeams::Layout::Page.build(rules) do |page|
            ...
            page.form do |form|
              form.caption 'Issue Empty Bins'
              form.action '/raw_materials/empty_bins/empty_bin_transactions/issue_empty_bins'
