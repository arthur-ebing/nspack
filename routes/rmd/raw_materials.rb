  ...
  route 'rmt_deliveries', 'rmd' do |r|
    ...
    r.on 'rmt_bins' do
      ...
      r.on 'receive_rmt_bins', Integer do |id|
        ...
        if capture_container_material && capture_container_material_owner && !AppConst::CR_RMT.all_delivery_bins_of_same_type?
  ...
  def new_bin_screen(delivery_id, action, notes = nil) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
    ...
    if bin_delivery
      ...
      form.behaviours do |behaviour|
        ...
        behaviour.dropdown_change :rmt_container_material_type_id, notify: [{ url: '/rmd/rmt_deliveries/rmt_bins/rmt_bin_container_material_type_combo_changed' }] if capture_container_material && capture_container_material_owner && !AppConst::CR_RMT.all_delivery_bins_of_same_type?
      end
