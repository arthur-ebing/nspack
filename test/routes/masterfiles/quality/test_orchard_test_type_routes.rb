...
class TestOrchardTestTypeRoutes < RouteTester
  ...
  INTERACTOR = MasterfilesApp::OrchardTestTypeInteractor

  def test_edit
    authorise_pass! permission_check: MasterfilesApp::TaskPermissionCheck::OrchardTestType
    ensure_exists!(INTERACTOR)
    Masterfiles::Quality::OrchardTestType::Edit.stub(:call, bland_page) do
  ...
  def test_show
    authorise_pass!
    ensure_exists!(INTERACTOR)
    Masterfiles::Quality::OrchardTestType::Show.stub(:call, bland_page) do
  ...
  def test_new
    authorise_pass!
    ensure_exists!(INTERACTOR)
    Masterfiles::Quality::OrchardTestType::New.stub(:call, bland_page) do
