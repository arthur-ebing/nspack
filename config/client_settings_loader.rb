class AppClientSettingsLoader # rubocop:disable Metrics/ClassLength
  REPLACE_RULES = { # These should become client rules!
    ...
    DELIVERY_USE_DELIVERY_DESTINATION: { env_key: 'USE_DELIVERY_DESTINATION',
                                         boolean: true,
                                         desc: 'Intended destination for a delivery of rmt_fruit eg. degreening or PH1' },
    ...
    PALLET_WEIGHT_REQUIRED_FOR_INSPECTION: { env_key: 'PALLET_WEIGHT_REQUIRED_FOR_INSPECTION',
                                             boolean: true,
                                             desc: 'optional. Bool to set if weight is required' },
