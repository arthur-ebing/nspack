    ...
    class ResourceDefinitions
      ...
      PLANT_RESOURCE_RULES = {
        ...
        ROOM => { description: 'Room',
                  allowed_children: [QC_ROBOT, BIN_SCALE_ROBOT, CARTON_SCALE_ROBOT, PALLET_SCALE_ROBOT, SCALE, PRINTER, SCANNER, WEIGHING_STATION],
                  icon: { file: 'home', colour: CLR_K } },
        LINE => { description: 'Line',
                  allowed_children: [SUB_LINE, DROP, PACK_POINT, DROP_TABLE, CLM_ROBOT, BIN_FILLER_ROBOT, QC_ROBOT, PALLETIZING_STATION, AUTOPACK_PALLET_BAY, PALLETIZING_BAY, BIN_TIPPING_STATION, SCALE, PRINTER, SCANNER, PRINT_STATION, ITPC],
                  icon: { file: 'packline', colour: CLR_S } },
        SUB_LINE => { description: 'Sub-Line',
                      allowed_children: [DROP, PACK_POINT, DROP_TABLE, CLM_ROBOT, BIN_FILLER_ROBOT, QC_ROBOT, PALLETIZING_STATION, AUTOPACK_PALLET_BAY, PALLETIZING_BAY, SCALE, PRINTER, SCANNER, PRINT_STATION, ITPC],
                      icon: { file: 'packline', colour: CLR_D } },
        DROP => { description: 'Drop',
                  allowed_children: [PACK_POINT, DROP_TABLE, CLM_ROBOT, BIN_FILLER_ROBOT, BIN_SCALE_ROBOT, CARTON_SCALE_ROBOT, PALLET_SCALE_ROBOT, SCALE, PRINTER, SCANNER],
        ...
        DROP_TABLE => { description: 'Drop table',
                        allowed_children: [PACK_POINT, CLM_ROBOT, BIN_FILLER_ROBOT, BIN_SCALE_ROBOT, CARTON_SCALE_ROBOT, PALLET_SCALE_ROBOT, SCALE, PRINTER, SCANNER],
        ...
        CARTON_VERIFICATION_STATION => { description: 'Carton-verification station',
                                         allowed_children: [CARTON_VERIFICATION_ROBOT, PRINTER, SCANNER],
        ...
        BIN_TIPPING_STATION => { description: 'Bin-tipping station',
                                 allowed_children: [BIN_TIPPING_ROBOT, STAGING_TIPPING_ROBOT, SCALE, SCANNER],
                                 icon: { file: 'cog', colour: CLR_U } },
        BIN_VERIFICATION_STATION => { description: 'Bin-verification station',
                                      allowed_children: [BIN_VERIFICATION_ROBOT, PRINTER, SCANNER],
                                      icon: { file: 'tag', colour: CLR_B } },
        ...
        WEIGHING_STATION => { description: 'Weighing station',
                              allowed_children: [BIN_SCALE_ROBOT, CARTON_SCALE_ROBOT, PALLET_SCALE_ROBOT, SCALE, PRINTER, SCANNER],
