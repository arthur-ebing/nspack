...
class EnvVarRules # rubocop:disable Metrics/ClassLength
  OPTIONAL = [
    ...
    { BUILDUP_PALLET_MIX: 'BUILDUP_PALLET_MIX pallet_mix rule.' },
    { PALLETIZING_PALLET_MIX: 'PALLETIZING_PALLET_MIX pallet_mix rule.' },
    { PALLETIZING_BAYS_PALLET_MIX: 'PALLETIZING_BAYS_PALLET_MIX pallet_mix rule.' },
    ...
    { USE_LABEL_ID_ON_BIN_LABEL: 'Use carton_label_id to lookup carton_labels existence. Default false' }
  ].freeze
