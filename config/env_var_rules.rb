...
class EnvVarRules # rubocop:disable Metrics/ClassLength
  OPTIONAL = [
    ...
    { TITAN_INSPECTION_API_USER_ID: 'Titan API_UserId for government inspections.' },
    { TITAN_INSPECTION_API_SECRET: 'Titan API_Secret for government inspections.' },
    { TITAN_ADDENDUM_API_USER_ID: 'Titan API_UserId for government addenda.' },
    { TITAN_ADDENDUM_API_SECRET: 'Titan API_Secret for government addenda.' },
    ...
    { DEFAULT_BIN_PALLET_FORMAT: 'Default pallet format for convert bins to pallet application.' },
    { DEFAULT_BASIC_PACK: 'Default basic pack for convert bins to pallet application.' },
    { DEFAULT_BIN_GRADE: 'Default grade for convert bins to pallet application.' },
    { BIN_UNKNOWN_SIZE_REF: 'Default size ref for convert bins to pallet application.' },
    { DEFAULT_BIN_PACKED_TM_GROUP: 'Default packed tm group for convert bins to pallet application.' },
    { DEFAULT_MARKETING_ORG: 'Default marketing org for convert bins to pallet application.' },
    { DEFAULT_BIN_MARK: 'Default mark for convert bins to pallet application.' },
    { DEFAULT_BIN_INVENTORY_CODE: 'Default inventory code for convert bins to pallet application.' },
    { DEFAULT_BIN_SELL_BY_CODE: 'Default sell by code for convert bins to pallet application.' },
