...
class AppConst # rubocop:disable Metrics/ClassLength
  ...
  # Defaults for bin to pallet conversion
  DEFAULT_BIN_PALLET_FORMAT = ENV['DEFAULT_BIN_PALLET_FORMAT']
  DEFAULT_BASIC_PACK = ENV['DEFAULT_BASIC_PACK']
  DEFAULT_BIN_GRADE = ENV['DEFAULT_BIN_GRADE']
  BIN_UNKNOWN_SIZE_REF = ENV['BIN_UNKNOWN_SIZE_REF']
  DEFAULT_BIN_PACKED_TM_GROUP = ENV['DEFAULT_BIN_PACKED_TM_GROUP']
  DEFAULT_MARKETING_ORG = ENV['DEFAULT_MARKETING_ORG']
  DEFAULT_BIN_MARK = ENV['DEFAULT_BIN_MARK']
  DEFAULT_BIN_INVENTORY_CODE = ENV['DEFAULT_BIN_INVENTORY_CODE']
  DEFAULT_BIN_SELL_BY_CODE = ENV['DEFAULT_BIN_SELL_BY_CODE']
