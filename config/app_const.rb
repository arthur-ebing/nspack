...
class AppConst # rubocop:disable Metrics/ClassLength
  ...
  REQUIRE_FRUIT_STICKER_AT_PALLET_VERIFICATION = ENV['REQUIRE_FRUIT_STICKER_AT_PALLET_VERIFICATION']
  COMBINE_CARTON_AND_PALLET_VERIFICATION = ENV['COMBINE_CARTON_AND_PALLET_VERIFICATION']
  CAPTURE_PALLET_NETT_WEIGHT_AT_VERIFICATION = ENV['CAPTURE_PALLET_NETT_WEIGHT_AT_VERIFICATION']
