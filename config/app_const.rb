...
class AppConst
  ...
  DELIVERY_RMT_CODE_ALLOCATED = 'RMT_CODE_ALLOCATED'
  DELIVERY_RMT_CLASSIFICATIONS_ADDED = 'RMT_CLASSIFICATIONS_ADDED'
  ...
  RUN_TYPE_BULK_REBIN_RUN_UPDATE = 'BULK REBIN RUN UPDATE'
  ...
  REWORKS_ACTION_BULK_REBIN_RUN_UPDATE = 'BULK REBIN RUN UPDATE'
  ...
  REWORKS_RUN_NON_PALLET_RUNS = {
    ...
    RUN_TYPE_BULK_REBIN_RUN_UPDATE => :prodrun,
  ...
  BARCODE_SCAN_RULES = [
    ...
    { regex: '^(\\d+)$', type: 'delivery', field: 'delivery_number' },
