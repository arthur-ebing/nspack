...
Works on `Multi.js` elements only. If the replacement options array includes values that are already selected in the UI, those options will remain selected.
