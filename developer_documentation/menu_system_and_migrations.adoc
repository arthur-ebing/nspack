...
Crossbeams::MenuMigrations::Migrator.migration('Nspack') do
  up do
    ...
    change_program_function 'Commodities',
                            ...
                            hide_if_const_true: 'CR_PROD.incentives?,PRINT_PALLET_LABEL_AT_PALLET_VERIFICATION'
  end
...
* `:hide_if_const_true` - (String of comma-separated AppConst constants or client rules) If any of the rules evaluate to true, the menu will be hidden
* `:hide_if_const_false` - (String of comma-separated AppConst constants or client rules) If any of the rules evaluate to false, the menu will be hidden

Each client rule is specified as `<AppConst varname>.<client_rule>` e.g. `CR_PROD.check_something?`
...
** `:hide_if_const_true` - (String of comma-separated AppConst constants or client rules) If any of the rules evaluate to true, the menu will be hidden. Set to nil to clear
** `:hide_if_const_false` - (String of comma-separated AppConst constants or client rules) If any of the rules evaluate to false, the menu will be hidden. Set to nil to clear
...
A user can be given permission to see a menu item in one of two ways:
